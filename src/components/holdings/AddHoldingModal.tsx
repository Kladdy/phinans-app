...
import AddHoldingDropdown from './AddHoldingDropdown';
...
export default function AddWalletModal({open, setOpen}) {
  ...
  const [holdingFields, setHoldingFields] = useState({})
  const [isSubmitting, setIsSubmitting] = useState(false)
  const [submissionErrors, setSubmissionErrors] = useState([])

  const renderForm = () => {

    return <AddHoldingForm holdingFields={holdingFields} 
            setHoldingFields={setHoldingFields} />
            ...
            <div className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <AddHoldingDropdown selected={selectedCategory} setSelected={setSelectedCategory} categories={categories} />
                  </div>
